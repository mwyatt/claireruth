...
-- Generation Time: Oct 28, 2013 at 06:25 AM
...
INSERT INTO `content_media` (`id`, `content_id`, `media_id`) VALUES
(9, 102, 2),
(15, 11, 1),
(14, 11, 2),
(41, 103, 18),
...
CREATE TABLE `content_tag` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `content_id` int(10) unsigned NOT NULL,
  `tag_id` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `content_id` (`content_id`)
...
(327, 3, 'essays'),
(326, 3, 'warwick'),
(325, 3, 'kafka on the shore'),
(340, 102, 'martin'),
(341, 102, 'pokemon'),
(342, 102, 'blackpool open'),
(343, 102, 'poetry'),
(344, 102, 'politics'),
(382, 11, 'national identity'),
(381, 11, 'marine le pen'),
(379, 11, 'english'),
(378, 11, 'lawrence'),
(377, 11, 'french'),
(386, 11, 'freedom'),
(465, 103, 'eg'),
(464, 103, 'here is a good one'),
(406, 101, 'politics'),
(463, 103, 'more some'),
(462, 103, 'type 8 seems');
