...
<?php endif ?>
	...
	<p class="medium-title"><?php echo ($medium->title) ? $medium->title : '') ?></p>
	<span class="medium-date-published"><?php echo ($medium->time_published) ? $medium->time_published : '') ?></span>
	<span class="medium-author"><?php echo ($medium->user_full_name) ? $medium->user_full_name : '') ?></span>
