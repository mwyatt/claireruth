 ...
 */
Model_Media_v2.prototype.refreshEventAttachedTags = function(event) {
 ...
 * @param {object} button 
 */
Model_Media_v2.prototype.create = function(data) {
	$.ajax({
 ...
 * @param  {string} query
 */
Model_Media_v2.prototype.search = function(event, query) {
	$.get(
 ...
 * @param {object} button 
 */
Model_Media_v2.prototype.aRemove = function(event, tag) {
 ...
 * depentant on meta
 */
Model_Media_v2.prototype.aAdd = function(event, tag) {
 ...
 */
Model_Media_v2.prototype.keyupSearchField = function(event, field) {
